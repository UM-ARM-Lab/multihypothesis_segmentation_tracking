...
public:
	...
	bool sampleAction(const SensorHistoryBuffer& buffer_out, const cv::Mat& firstFrameSeg, std::unique_ptr<Tracker>& sparseTracker, std::unique_ptr<DenseTracker>& denseTracker, uint16_t label, mps_msgs::AABBox2d& bbox);
